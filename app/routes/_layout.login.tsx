  ...
  return (
    <div>
      ...
      {data?.passwordError && <div className="font-thin text-red-700">{data.passwordError}</div>}
        ...
        <button className="btn btn-neutral btn-sm md:btn-md" type="submit">Login</button>
        <Link to="/signup" className="text-sm md:text-xl underline cursor-pointer place-content-center">Sign Up</Link>
        </div>
        </div>
      </Form>
    </div>
